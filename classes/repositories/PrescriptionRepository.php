...
class PrescriptionRepository extends BaseRepository {
    ...
    public function findByDoctor($doctorId) {
        $stmt = $this->pdo->prepare(" SELECT prescriptions.*, medications.name as medication_name, medications.description as medication_description, patient_user.first_name as patient_first_name, patient_user.last_name as patient_last_name
            FROM prescriptions
            INNER JOIN medications ON prescriptions.medication_id = medications.id
            INNER JOIN User as patient_user ON prescriptions.patient_id = patient_user.id

...
class AppointmentRepository extends BaseRepository {
    ...
    public function findByDoctor($doctorId) {
        $stmt = $this->pdo->prepare("
            SELECT appointments.* , patient_user.first_name as patient_first_name, patient_user.last_name as patient_last_name
            FROM appointments
            INNER JOIN User as patient_user ON appointments.patient_id = patient_user.id
    ...
    public function findByPatient($patientId) {
        $stmt = $this->pdo->prepare("
            SELECT appointments.*, doctor_user.first_name as doctor_first_name, doctor_user.last_name as doctor_last_name
            FROM appointments
            INNER JOIN User as doctor_user ON appointments.doctor_id = doctor_user.id
